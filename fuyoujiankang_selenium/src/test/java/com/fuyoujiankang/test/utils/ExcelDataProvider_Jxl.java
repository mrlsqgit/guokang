 ...
 *               Excel第一行为Map键值<br>
 */
public class ExcelDataProvider_Jxl implements Iterator<Object[]> {
	...
	public static Logger logger = Logger.getLogger(ExcelDataProvider_Jxl.class
			.getName());

	/*
	 * @description 2个参数：<br> moduleName - 模块的名称 caseNum - 测试用例编号
	 */
	public ExcelDataProvider_Jxl(String moduleName, String caseNum) {
