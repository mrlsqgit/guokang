package com.fuyoujiankang.test.plugins.arrow;
...
public class TestResultListener extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {    // 这里也是新加的，用于对context进行统一
		...
		browser = String.valueOf(testContext.getCurrentXmlTest().getParameter(
				"browserName"));
	...
	public void onTestFailure(ITestResult tr) {
		...
		WebDriver webDriver = (WebDriver) testContext
				.getAttribute("SELENIUM_DRIVER"); // 这里就是取driver
