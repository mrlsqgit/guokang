...
public class InquiryPage {
	...
	/** 发送问诊消息 */
	public static final By IP_TEXTVIEW_SEND = By.name("发送");  
	/** 开始问诊 */
	public static final By IP_TEXTVIEW_BEGININTERROGATION = By.name("开始问诊"); 
	/** 预约挂号*/
	...
	/** 选择预约时间-下一步*/
	public static final By IP_TEXTVIEW_NEXT = By.name("下一步");
}
