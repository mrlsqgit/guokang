...
//		appiumUtil.click(CommonPage.CP_TEXTVIEW_CONFIRMPAYMENT);
	...
	/**
	 * @author Jone
	 * @description 我的预约挂号-待支付-立即支付 操作封装
	 * @param AppiumUtil
	 *            appium api封装引用对象
	 */
	public static void payNow(AppiumUtil appiumUtil) {
		logger.info("我的预约挂号-待支付-立即支付");
	...
	/**
	 * @author Jone
	 * @description 我的预约-待使用-查看订单详情操作封装
	 * @param AppiumUtil
	 *            appium api封装引用对象
	 */
	public static void viewOrderDetails(AppiumUtil appiumUtil) {
		logger.info("我的预约-待使用-查看订单详");
		// 获得待使用订单列表"已付款"字段集合
