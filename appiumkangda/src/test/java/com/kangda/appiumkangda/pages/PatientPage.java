...
/**
 * @author jone
 * @description 就诊人管理页面元素
 */

public class PatientPage {
	/** 添加亲友按钮 */
	public static final By PP_BUTTON_ADDFRIENDS = By.name("添加就诊人");
	/** 编辑 */
	...
	/** 身份证输入框 */
	public static final By PP_INPUT_ID = By.name("请填写身份证号");
	/** 性别选择 */
	public static final String PP_TEXTVIEW_SELECT = "请选择";
	/** 性别，关系，居住地classname */
